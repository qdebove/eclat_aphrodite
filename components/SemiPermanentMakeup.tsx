export default function SemiPermanentMakeup() {
  const colors = [
    { name: 'Red Rose', src: '/assets/swatches/red-rose.png' },
    { name: 'Mars Red', src: '/assets/swatches/mars-red.png' },
    { name: 'Berry Red', src: '/assets/swatches/berry-red.png' },
  ];
  return (
          ...
          <div className="grid grid-cols-3 items-center gap-4">
            {colors.map((c, i) => (
              <div key={i} className="text-center">
                <img src={c.src} alt={c.name} className="mx-auto rounded-full w-16 h-16" />
